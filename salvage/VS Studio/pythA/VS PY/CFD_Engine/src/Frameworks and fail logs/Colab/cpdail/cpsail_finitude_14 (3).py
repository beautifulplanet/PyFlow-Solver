...
# Define comprehensive test cases for function definition and calls (kept for reference)
code_function_tests = """
...
# Select a subset of tests for Batch 1
code_function_tests_batch1 = """
# Test Case 6.1: Simple function definition and call with no arguments or return
:func: greet <> {
    ~@ message => 1; # Just assign a value to a local variable
};
...
# Select a subset of tests for Batch 2
code_function_tests_batch2 = """
# Test Case 6.8: Function call within an expression
...
~@ factorial_of_neg_5 => !> factorial -|< 0 5;
