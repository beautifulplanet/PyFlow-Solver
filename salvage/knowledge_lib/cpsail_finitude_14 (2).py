...
# --- Start of content from /content/cpsail_b_prototype_ (3).py ---
...
print("\n--- Testing Function Definition and Calls (Batch 2) ---")

try:
    print("Source Code:\n", code_function_tests_batch2)
    tokens_func = tokenize(code_function_tests_batch2)
    print("\nTokens:\n", tokens_func)
    ...
    for name, value in interpreter_func.global_scope.items():
        if name != "_parent":
            print(f"  {name} = {value}")
    print("\nBatch 2 Function tests finished.")

    # Analyze the results of Batch 2
    expected_results_batch2 = {
        "complex_calc": 17.0,
        "nested_result": 12.0,
        "global_base": 100.0,
        ...
        "shadow_test": 999.0,
        "shadow_result": 10.0,
        "global_shadow_check": 999.0,
        "factorial_of_5": 120.0,
        "factorial_of_0": 1.0,
        "factorial_of_1": 1.0,
        "factorial_of_neg_5": 1.0,
    }

    print("\n--- Analyzing Batch 2 Function Test Results ---")
    discrepancies = []

    actual_results = {name: fn.get_value() for name, fn in interpreter_func.global_scope.items() if name != "_parent"}

    for var_name, expected_value in expected_results_batch2.items():
    ...
    unexpected_vars = [name for name in actual_results if name not in expected_results_batch2 and name not in function_names]
    if unexpected_vars:
    ...
    if discrepancies:
        ...
        print("\nNo discrepancies found in Batch 2. All tested function features passed with the updated code!")


except (SyntaxError, RuntimeError) as e:
    print(f"\nBatch 2 Function tests failed during execution: {e}")
