# -*- coding: utf-8 -*-
"""CPSAIL Version 0.001 Prototype .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1fjLUOSMEwONxKmnZuldv3u6xkeerQ1dT
"""
...
class TextRecognitionOperator:
    ...
    def recognize_text(self, image_path):
        ...
        try:
            ...
            # --- Enhanced Preprocessing using OpenCV as recommended by 20ccp.txt ---
            ...
            # Apply a median filter for noise reduction
            img_denoised_cv = cv2.medianBlur(img_cv, 5) # Using a kernel size of 5 as an example
            print("Applied median filter for noise reduction.")
            ...
            img_thresholded_cv = cv2.adaptiveThreshold(
                img_denoised_cv, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 11, 2 # Example parameters
            )
            ...
            custom_config = r'--oem 3 --psm 6' # Using PSM 6 as it's good for single blocks of text
            extracted_text = pytesseract.image_to_string(image_to_ocr, config=custom_config)
            print(f"Extracted text: '{extracted_text.strip()}'")
            # ---------------------------------------
...
print("TextRecognitionOperator class modified with enhanced preprocessing using OpenCV.")
